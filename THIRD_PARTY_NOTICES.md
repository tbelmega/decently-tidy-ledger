...
The following font files are distributed with Decently Tidy Ledger under the SIL Open Font
License, Version 1.1. The project MIT License does not replace or modify these terms.

## IBM Plex Sans

Files:

- `public/fonts/ibm-plex-sans.woff2`
- `public/fonts/ibm-plex-sans-italic.woff2`
...
File: `public/fonts/jetbrains-mono.woff2`
...
File: `public/fonts/space-grotesk.woff2`
...
The inline file icon in `public/ledger.html` is adapted from Lucide's `file` icon.
